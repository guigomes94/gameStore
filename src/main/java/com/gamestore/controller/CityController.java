...
import com.gamestore.service.CityService;
...
public class CityController {
	...
	@PutMapping("/{id}")
	public ResponseEntity<?> update(@PathVariable Long id, @RequestBody City obj) {
		City updated = service.update(id, obj);
